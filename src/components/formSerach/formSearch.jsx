export default function FormSearch() {
    return (
        <div className="max-w-[1728px] almarai px-28 mx-auto">
            <form action="/" className='mt-16 flex shadow-md px-10 py-6 w-11/12 mx-auto justify-between rounded-[30px] gap-3 border border-[#9494946b]'>
